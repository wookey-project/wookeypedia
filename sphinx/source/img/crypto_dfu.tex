...
\node[minimum width=8.5cm, minimum height=1.15cm, fill=gray!20, yshift=1.2cm, xshift=4.4cm] (a) {};
\node[rotate=-90, yshift=.2cm, xshift=-.15cm] (alabel) at (a.east) {$\scriptstyle\text{\underline{Open session}}$};

\node[minimum width=8.5cm, minimum height=1.0cm, fill=gray!40, yshift=-.2cm, xshift=4.4cm] (b) {};
\node[rotate=-90, yshift=.2cm, xshift=.05cm] (blabel) at (b.east) {$\scriptstyle\text{\underline{Chunk 0}}$};

\node[minimum width=8.5cm, minimum height=1.0cm, fill=gray!40, yshift=-1.65cm, xshift=4.4cm] (c) {};
