...
\begin{tikzpicture}[scale=0.95]
  ...
  \draw (-35:2.0) node {\small Smart card};
  \draw (-50:2.0) node {\small \&};
  \draw (-65:2.2) node {\small integrity};
  
  \draw (30:2.1) node {\small DFU};
  \draw (20:2.1) node {\small stack};
  \draw (90:2.0) node {\small crypto};
  \draw (150:2.1) node {\small Flash};
  \draw (160:2.1) node {\small manager};

  % crypto to smartcard
  \draw [very thick] (0.7,0) arc (0:85:0.7);
  \draw [very thick] (0.7,0) arc (0:-40:0.7);
  \draw (0.2,0.4) node {\it \tiny IPC};
  \draw [very thick,-latex] (0.08,0.67) -- (0.08,1.8);
  \draw [very thick,-latex] (0.55,-0.42) -- (1.7,-0.42);
  \draw (2.3,-0.5) node[left] {\tiny\it key};
  \draw (2.5,-0.7) node[left] {\tiny\it schedule};
  
  % crypto to smartcard
  \draw [very thick] (0.85,0) arc (0:40:0.85);
  \draw [very thick] (0.85,0) arc (0:-15:0.85);
  %\draw (0.2,0.5) node {\it \tiny IPC};
  \draw [very thick,-latex] (40:0.85) -- (40:1.5);
  \draw [very thick,-latex] (0.85,-0.2) -- (1.8,-0.2);
  \draw (2.5,-0.2) node[left] {\tiny\it auth};
  ...
  \draw (150:3.5) node[left] {\small Flash bank};
  ...
  \draw (-25:3.5) node[right] {\small ISO7816/USART};
  \draw (-25:3.5) node[below right] {\footnotesize\it memory mapped};
  \draw (-30:3.5) node[below right] {\footnotesize\it device};

   %
  \draw [dashed] (-55:3.1)--(-55:2.7)--(-45:2.7)--(-45:3.1);
  \draw [double distance=1pt,-latex] (-50:3.1) -- (-50:3.5);
  \draw (-50:3.5) node[right, xshift=.1cm, yshift=-.25cm] (cryp2l) {};
  \filldraw [fill=gray!30] (cryp2l) circle (0.4);
  \draw (-50:3.5) node[right, yshift=-.25cm, xshift=-.26cm] (cryp2) {\texttt{CRYP}};
  \draw (-50:3.5) node[below right, yshift=0cm, xshift=.7cm] {\footnotesize\it Key injection};
  \draw (-53:3.7) node[below right, xshift=.7cm] {\footnotesize\it only};

   %
  \draw [dashed] (-80:3.1)--(-80:2.7)--(-70:2.7)--(-70:3.1);
  \draw [double distance=1pt,-latex] (-75:3.1) -- (-75:3.5);
  \draw (-75:3.7) node {\small HASH};
  \draw (-75:4) node {\small \footnotesize\it memory mapped device};
  \draw [very thick,->,dashed,color=red,>=latex] (0.3,-3.6) -- (-1,-3.6);
  \draw (0.3,-3.6) node[above left] {\tiny\color{red}{DMA}};
  \draw (-1.9,-3.6) node {\small Flash bank};
  ...
  \draw (-130:3.5) node[left] {\small Touchscreen};
